...
6. 사용자가 확정된 문서를 언급하며 구현을 요청하면 `start-implementation-thread`를 적용해 별도의 Codex 작업에서 구현을 시작합니다.
...
- 구현 승인 후 현재 작업에서 직접 코드를 수정하지 말고 `start-implementation-thread`에 문서 경로를 전달합니다.
