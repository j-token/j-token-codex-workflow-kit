...
8. 기술 스펙을 저장한 직후 `audit-technical-spec`을 적용해 별도의 외부 thread에서 구현 가능성, 블로커, 사실 불일치와 계약·검증 공백을 감사합니다.
...
- 기술 스펙 작성 직후에는 구현하지 않고 `audit-technical-spec`으로 독립 감사를 요청합니다.
